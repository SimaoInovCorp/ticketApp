...
const form = useForm({
    ...
    internal_notes: props.entity.internal_notes ?? '',
});

function submit() {
    form.put(EntityController.update.url(props.entity.id));
}
...
<template>
    ...
    <div class="mx-auto max-w-2xl p-4">
        <h1 class="mb-1 text-2xl font-semibold">Edit Entity</h1>
        <p class="mb-6 text-sm text-muted-foreground">
            Update the details for this organisation. Changes are saved
